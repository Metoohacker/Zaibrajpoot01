...
logo = """
/   <🅆🄴🄻🄲🄾🄼🄴>
  \        By Zaib Rajpoot and Abdul Mateen                                                                                                                                                                                               
..#######.Brothers #####....#####....#######.
.##.....##.##.....##..##...##..##.....##
........##.Zaib rajpoot ##........##
..#######...and#####..##...##..#######.
...
"࿇ ══━━━━✥ⓌⒺⓁⒸⓄⓂ︎Ⓔ✥━━━━══ ࿇"
\033[32mBy Zaib Rajpoot and Abdul Mateen
 """                       
print "╔╣█╠╗╚𝗟𝗢𝗚𝗜𝗡╝╔╣█╠╗"

Username = "zaibrajpoot"
Password = "abdulmateen"
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://t.me/i4m_Tkyo')
...
def pilih_super():
    ...
    jalan('          \033[1;91mZaib and Metoo Start Cracking Plaese Wait ...')
    print  "  \033[1;36;48m ●🕐═══════════════════════◄►════════════════════════🗏" 
